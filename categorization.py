...
def fuck_nlp(model_name, content):
    ...
    #
    chose_model = 'models.'+model_name+''
    print('model:', chose_model)
    x = import_module(chose_model)
...
if __name__ == '__main__':
    a = fuck_nlp("Transformer","我好喜欢这只股票啊，能让我赚的盆满钵满")
    print(a)